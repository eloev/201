package com.android.mpdev.vkrapp.ui.ar
...
import com.android.mpdev.vkrapp.databinding.ActivityArBinding
import com.android.mpdev.vkrapp.ui.ar.helpers.CameraPermissionHelper
import com.android.mpdev.vkrapp.ui.ar.helpers.DisplayRotationHelper
import com.android.mpdev.vkrapp.ui.ar.helpers.FullScreenHelper
import com.android.mpdev.vkrapp.ui.ar.helpers.TrackingStateHelper
import com.android.mpdev.vkrapp.ui.ar.rendering.AugmentedImageRenderer
...
class ARActivity : AppCompatActivity(), GLSurfaceView.Renderer {
    ...
    override fun onResume() {
        ...
        try {
            ...
            Log.d(TAG, "Camera not available. Try restarting the app.")
            session = null
            return
        }
    ...
    private fun setupAugmentedImageDatabase(config: Config): Boolean {
        ...
        if (useSingleImage) {
            ...
            augmentedImageDatabase.addImage("image_name", augmentedImageBitmap, 0.12F)
